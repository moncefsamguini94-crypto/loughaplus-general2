...
export function StickyCta() {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-x-0 bottom-0 z-50 border-t border-[#E5E7EB] bg-white/95 backdrop-blur-lg md:hidden"
    ...
    >
      <div className="container flex items-center gap-3 py-3">
        <Button
          asChild
          size="lg"
          className="btn-no-motion h-14 flex-1 rounded-xl bg-[#2518B8] shadow-[0_8px_20px_rgba(37,24,184,0.25)] hover:bg-[#1D1499]"
        ...
        <Button
          ...
          className="btn-no-motion size-14 rounded-xl"
        >
