  ...
  return (
    <section className="section-shell bg-muted">
      <div className="container">
        <SectionHeading title={whyUs.title} subtitle={whyUs.subtitle} />
        ...
        <Reveal delay={0.1}>
          <div className="mx-auto mt-10 grid max-w-5xl overflow-hidden rounded-3xl border border-border bg-card shadow-lg lg:grid-cols-2">
            <div className="relative min-h-[260px] bg-brand-900 lg:order-2">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/general-secondary.webp"
                alt="تعلم الإنجليزية عن بعد مع Lougha Institute"
                width={1100}
                height={733}
                loading="lazy"
                decoding="async"
