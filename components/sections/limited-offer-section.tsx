  ...
  return (
    <section className="section-shell relative overflow-hidden bg-brand-900 text-white">
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(60% 58% at 50% -5%, rgba(147,79,232,.42) 0%, transparent 62%), radial-gradient(42% 42% at 8% 70%, rgba(232,79,194,.24) 0%, transparent 60%), radial-gradient(38% 38% at 92% 75%, rgba(20,200,180,.25) 0%, transparent 65%)",
        }}
      />
